...
public class BusinessConstant {
    ...
    //发布之前修改
    public static final String backDoorStr = "114103";

    //绿色 通道
    public static final String backDoorPwd = "Jiangchsh418";

    //15天内不能接单
    public static final Integer CAN_NOT_ACCEPT_TASK_DAYS = 15;
